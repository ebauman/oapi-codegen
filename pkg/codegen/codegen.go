...
import (
	...
	"github.com/ebauman/oapi-codegen/pkg/codegen/templates"
)
...
var (
	allGoImports = goImports{
		...
		{lookFor: "openapi_types\\.", alias: "openapi_types", packageName: "github.com/ebauman/oapi-codegen/pkg/types"},
		{lookFor: "path\\.", packageName: "path"},
		{lookFor: "runtime\\.", packageName: "github.com/ebauman/oapi-codegen/pkg/runtime"},
